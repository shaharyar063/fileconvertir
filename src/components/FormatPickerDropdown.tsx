...
export function FormatPickerDropdown({
  ...
  return (
    <div className="relative flex-1" ref={ref}>
      ...
      {/* Dropdown Panel */}
      {open && (
        <div className="absolute left-0 top-[calc(100%+6px)] z-50 w-full min-w-[320px] overflow-hidden rounded-xl border border-border bg-card shadow-xl shadow-black/40 md:min-w-[400px]">
          <div className="flex">
            {/* Category Sidebar */}
            <div className="w-[120px] shrink-0 border-r border-border bg-secondary/30 py-1 md:w-[140px]">
              {categories.map(cat => {
                const Icon = cat.icon;
                return (
                  <button
